...
// import { Tag, Package, TrendingUp, Search, Download, FileText, ChevronDown, X, Filter, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from "lucide-react";
// import { toast } from "sonner";

// // Export utility functions
// const exportCategoriesCSV = (data: any[], filename: string = "categories.csv") => {
//   const headers = ["Category", "Products", "Total Stock", "Total Value", "Low Stock Items"];
...
// const exportCategoriesExcel = (data: any[], filename: string = "categories.xlsx") => {
//   const headers = ["Category", "Products", "Total Stock", "Total Value", "Low Stock Items"];
//   const rows = data.map((cat) => [
//     cat.category,
//     cat.count,
...
// const exportCategoriesPDF = (data: any[], filename: string = "categories.pdf") => {
//   const htmlContent = `
//     <!DOCTYPE html>
//     <html>
//     <head>
...
//               <td>$${cat.totalValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
//               <td>${cat.lowStock}</td>
//             </tr>
//           `
//             )
...
//                 Page {currentPage} of {totalPages} ({categoryStats.length} total)
//               </div>
