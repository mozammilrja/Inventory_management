...
// 🧩 Get Products with Search, Filtering, Pagination, Sorting, and KPIs
...
// 🧩 SINGLE POST function handling multiple actions
...
// // Utility function to manually clear cache (for webhooks, etc.)
// export function clearProductCache() {
//   const cacheSize = cache.size;
//   cache.clear();
//   // console.log(`🧹 Cleared product cache (${cacheSize} entries)`);
//   return cacheSize;
// }
