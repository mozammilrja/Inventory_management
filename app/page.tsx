        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex h-14 sm:h-16 items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
              ...
              <Button asChild size="sm" className="bg-slate-900 hover:bg-slate-800 dark:bg-slate-50 dark:hover:bg-slate-200 dark:text-slate-900 text-xs sm:text-sm px-2 sm:px-4">
                <Link href="/register">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center px-4">
            <Button size="lg" asChild className="bg-slate-900 hover:bg-slate-800 dark:bg-slate-50 dark:hover:bg-slate-200 dark:text-slate-900 text-base sm:text-lg px-6 sm:px-8 h-12 sm:h-auto">
              <Link href="/register">
                Start Free Trial
                <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="text-base sm:text-lg px-6 sm:px-8 h-12 sm:h-auto">
              <Link href="/login">
                Sign In
              </Link>
            </Button>
                ...
                <div className="bg-white dark:bg-slate-950 rounded-lg shadow-xl p-3 sm:p-6 border border-slate-200 dark:border-slate-800">
                  <div className="flex items-center gap-2 mb-3 sm:mb-4">
                    ...
                    <div className="flex-1 bg-slate-100 dark:bg-slate-900 rounded px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs text-slate-600 dark:text-slate-400 overflow-hidden">
                      <span className="block truncate">assetpro.app/dashboard</span>
                    </div>
                  </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm">Active Users</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm">Uptime</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm">Assets Tracked</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm">Support</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
          <div className="relative">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Create Account</h3>
          ...
          <div className="relative">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Add Your Assets</h3>
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">
            ...
            <CardContent className="p-5 sm:p-8">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">IT Departments</h3>
          ...
          <Card className="border-2 hover:shadow-xl transition-all group">
            <CardContent className="p-5 sm:p-8">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Operations Teams</h3>
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-3 sm:mb-4">
          ...
          <Card className="border-2 hover:shadow-xl transition-all group">
            <CardContent className="p-5 sm:p-8">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Finance Teams</h3>
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-3 sm:mb-4">
          ...
          <Card className="border-2 hover:shadow-xl transition-all group">
            <CardContent className="p-5 sm:p-8">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Facilities Management</h3>
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-3 sm:mb-4">
          ...
          <Card className="border-2 overflow-hidden group hover:shadow-2xl transition-all">
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">Real-Time Analytics</h3>
              ...
              <div className="p-5 sm:p-6 space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Live dashboard updates</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-purple-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Custom report builder</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-indigo-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Export to multiple formats</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 overflow-hidden group hover:shadow-2xl transition-all">
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">Smart Notifications</h3>
              ...
              <div className="p-5 sm:p-6 space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Automated alerts</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Maintenance reminders</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-teal-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Low stock warnings</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 overflow-hidden group hover:shadow-2xl transition-all">
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-orange-500 to-red-600 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">Team Collaboration</h3>
              ...
              <div className="p-5 sm:p-6 space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Role-based permissions</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-red-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Activity tracking</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-pink-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Comment & notes</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 overflow-hidden group hover:shadow-2xl transition-all">
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-purple-500 to-pink-600 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">API Integration</h3>
              ...
              <div className="p-5 sm:p-6 space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-purple-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">RESTful API access</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-pink-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Webhook support</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-fuchsia-500 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Third-party integrations</span>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 bg-gradient-to-br from-slate-100/50 to-slate-50/50 dark:from-slate-900/50 dark:to-slate-800/50 rounded-2xl sm:rounded-3xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
          <Card className="border-2 text-center hover:shadow-lg transition-all">
            <CardContent className="p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1.5 sm:mb-2">SSL Encryption</h3>
          ...
          <Card className="border-2 text-center hover:shadow-lg transition-all">
            <CardContent className="p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1.5 sm:mb-2">Daily Backups</h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
          ...
          <Card className="border-2 text-center hover:shadow-lg transition-all">
            <CardContent className="p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1.5 sm:mb-2">SOC 2 Certified</h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
          ...
          <Card className="border-2 text-center hover:shadow-lg transition-all">
            <CardContent className="p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1.5 sm:mb-2">24/7 Monitoring</h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
        ...
        <div className="mt-8 sm:mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-8 opacity-60">
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-slate-400 dark:text-slate-600">COMPANY</div>
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-slate-400 dark:text-slate-600">BRAND</div>
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-slate-400 dark:text-slate-600">CORP</div>
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-slate-400 dark:text-slate-600">TECH</div>
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-slate-400 dark:text-slate-600">GLOBAL</div>
          </div>
        </div>
      </section>
            ...
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  <div className="font-semibold text-xs sm:text-sm truncate">John Doe</div>
                  <div className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 truncate">IT Manager, TechCorp</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  <div className="font-semibold text-xs sm:text-sm truncate">Sarah Miller</div>
                  <div className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 truncate">Operations Lead, GlobalCo</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 sm:col-span-2 md:col-span-1">
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="min-w-0">
                  <div className="font-semibold text-xs sm:text-sm truncate">Mike Johnson</div>
                  <div className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 truncate">CFO, StartupXYZ</div>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="border-2 hover:shadow-xl transition-all">
            <CardContent className="p-6 sm:p-8">
              <div className="mb-5 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Starter</h3>
                <div className="flex items-baseline gap-2 mb-3 sm:mb-4">
                  <span className="text-3xl sm:text-4xl font-bold">$0</span>
                  <span className="text-sm sm:text-base text-slate-600 dark:text-slate-400">/month</span>
                </div>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                  Perfect for small teams getting started
                </p>
              </div>
              <Button asChild className="w-full mb-5 sm:mb-6 h-10 sm:h-11 text-sm sm:text-base" variant="outline">
          ...
          <Card className="border-2 border-slate-900 dark:border-slate-50 shadow-2xl relative overflow-hidden">
            ...
            <CardContent className="p-6 sm:p-8">
              <div className="mb-5 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Professional</h3>
                <div className="flex items-baseline gap-2 mb-3 sm:mb-4">
              ...
              <Button asChild className="w-full mb-5 sm:mb-6 h-10 sm:h-11 text-sm sm:text-base bg-slate-900 hover:bg-slate-800 dark:bg-slate-50 dark:hover:bg-slate-200 dark:text-slate-900">
          ...
          {/* Enterprise Plan */}
          <Card className="border-2 hover:shadow-xl transition-all md:col-span-3 lg:col-span-1">
            <CardContent className="p-6 sm:p-8">
              <div className="mb-5 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2">Enterprise</h3>
                <div className="flex items-baseline gap-2 mb-3 sm:mb-4">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 bg-gradient-to-br from-slate-100/50 to-slate-50/50 dark:from-slate-900/50 dark:to-slate-800/50 rounded-2xl sm:rounded-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 max-w-5xl mx-auto">
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-blue-500 to-blue-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-purple-500 to-purple-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-green-500 to-green-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-orange-500 to-orange-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
                <span className="flex-1">What kind of support do you offer?</span>
              </h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-red-500 to-red-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
          ...
          <Card className="border-2">
            <CardContent className="p-5 sm:p-6">
              <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 flex items-start gap-2">
                <span className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs sm:text-sm flex-shrink-0">?</span>
          ...
          <CardContent className="p-8 sm:p-12 text-center relative z-10">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                <Button size="lg" asChild className="bg-white hover:bg-white/90 text-purple-600 text-base sm:text-lg px-6 sm:px-8 shadow-xl font-semibold h-12 sm:h-auto">
                  <Link href="/register">
                    Create Free Account
                    <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                  </Link>
                </Button>
                <Button size="lg" asChild className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border-2 border-white text-base sm:text-lg px-6 sm:px-8 shadow-xl font-semibold h-12 sm:h-auto">
                  <Link href="/login">
                    Sign In
                  </Link>
                </Button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-2 sm:gap-3">
                <Button size="sm" variant="outline" className="rounded-full w-8 h-8 sm:w-10 sm:h-10 p-0">
            ...
            {/* Product Links */}
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-3 sm:mb-4 text-sm sm:text-base">Product</h3>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="/register" className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50 transition-colors">
                    Features
                  </Link>
                </li>
                <li>
            ...
            {/* Company Links */}
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-3 sm:mb-4 text-sm sm:text-base">Company</h3>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="/register" className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50 transition-colors">
                    About Us
            ...
            {/* Resources Links */}
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-3 sm:mb-4 text-sm sm:text-base">Resources</h3>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="/login" className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-50 transition-colors">
                    Sign In
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-6 sm:pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
              ...
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                <Link href="/register" className="hover:text-slate-900 dark:hover:text-slate-50 transition-colors whitespace-nowrap">
                  Privacy Policy
                </Link>
                <Link href="/register" className="hover:text-slate-900 dark:hover:text-slate-50 transition-colors whitespace-nowrap">
                  Terms of Service
